...
def getProductDetails():
    ...
    capacity2 = driver.find_element(By.XPATH,'//*[@id="itemBrief"]/div/table/tbody/tr[1]/td[1]/font/font').get_attribute("innerText").replace("\n"," ")
    ...
    KeySpecifications = driver.find_element(By.XPATH,'//*[@id="itemBrief"]/div/table/tbody/tr[1]/td[2]/font/font').get_attribute("innerText").replace("\n"," ")
    textBetween = ""
